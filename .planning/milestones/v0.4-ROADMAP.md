...
- [x] **Phase 3: Run Execution & History** - Trigger a run, poll to terminal, honest waiting, prior-run list with failures shown (completed 2026-07-19)
- [x] **Phase 4: Results & Insights** - Coverage cards, demand-vs-served chart, schedule table, on-demand insight report (completed 2026-07-20)
...
- [x] 02-05-PLAN.md — Write surface: TranscriptEntry/ConstraintTranscript + ConstraintInput + ProviderDownBanner (Wave 4)

**Wave 5** *(blocked on Wave 4)*

- [x] 02-06-PLAN.md — Editor route composition + App.tsx wiring + session transcript state (Wave 5)
...
- [x] 04-01-PLAN.md — recharts [SUS] blocking-human legitimacy gate + shadcn card/chart/tooltip install (Wave 1)
- [x] 04-02-PLAN.md — Typed read contract: hand-written RunResult + getRunResult/getRunInsights/getRun, formatShiftWindow, docs/API.md warnings fix (Wave 1)
...
| 4. Results & Insights | v0.4 | 8/8 | Complete    | 2026-07-20 |
