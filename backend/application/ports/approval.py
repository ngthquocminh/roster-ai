...
class ApprovalRepository(Protocol):
    ...
    def get_pending_payload(self, connection: Any, *, approval_id: UUID, site_id: UUID) -> dict | None: ...
    ...
    def consume(self, connection: Any, *, approval_id: UUID, site_id: UUID, decided_by_actor_id: UUID, decided_at: datetime, expected_resource_version: int) -> ApprovalBindingV1 | None: ...
