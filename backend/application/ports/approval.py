...
class ApprovalRepository(Protocol):
    ...
    def get(self, connection: Any, *, approval_id: UUID) -> ApprovalBindingV1 | None: ...
    def list_for_schedule_run(self, connection: Any, *, schedule_run_id: UUID) -> tuple[ApprovalBindingV1, ...]: ...
    def get_pending_for_agent_run(self, connection: Any, *, agent_run_id: UUID) -> ApprovalBindingV1 | None: ...
