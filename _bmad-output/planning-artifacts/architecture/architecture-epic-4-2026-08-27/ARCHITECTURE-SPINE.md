...
- **Prevents:** the first real promotion silently turning Story 3.8's honest empty-baseline comparison into a false "all assignments net-new" claim (the exact hazard `deferred-work.md`'s 3.8/3.10 entries record)
