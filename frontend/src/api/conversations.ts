...
export type Conversation = Root["get"]["responses"][200]["content"]["application/json"][number];
...
export async function listConversations(scenarioId: string): Promise<Conversation[]> {
